...
const SCENARIOS = [
  ...
  { slug:'l1-park-question', personaSlug:'amira-hotel', level:'L1', difficulty:'easy',
  ...
  { slug:'l2-job-interview-call', personaSlug:'omar-taxi', level:'L2', difficulty:'medium',
  ...
  { slug:'l2-volunteer-signup', personaSlug:'amira-hotel', level:'L2', difficulty:'medium',
  ...
  { slug:'l2-tech-support-internet', personaSlug:'omar-taxi', level:'L2', difficulty:'medium',
  ...
  { slug:'l3-negotiate-salary', personaSlug:'omar-taxi', level:'L3', difficulty:'medium',
  ...
  { slug:'l3-roommate-conflict', personaSlug:'amira-hotel', level:'L3', difficulty:'medium',
  ...
  { slug:'l3-explain-misunderstanding', personaSlug:'omar-taxi', level:'L3', difficulty:'medium',
  ...
  { slug:'l4-disagree-meeting', personaSlug:'omar-taxi', level:'L4', difficulty:'challenging',
  ...
  { slug:'l4-explain-complex-idea', personaSlug:'omar-taxi', level:'L4', difficulty:'challenging',
  ...
  { slug:'l4-decline-invitation-tactfully', personaSlug:'amira-hotel', level:'L4', difficulty:'challenging',
  ...
  { slug:'l4-business-pitch-investor', personaSlug:'omar-taxi', level:'L4', difficulty:'challenging',
  ...
  { slug:'l5-negotiate-multi-party', personaSlug:'omar-taxi', level:'L5', difficulty:'challenging',
  ...
  { slug:'l5-give-difficult-feedback', personaSlug:'omar-taxi', level:'L5', difficulty:'challenging',
  ...
  { slug:'l5-policy-debate-formal', personaSlug:'omar-taxi', level:'L5', difficulty:'challenging',
  ...
  { slug:'l5-deliver-bad-news-team', personaSlug:'omar-taxi', level:'L5', difficulty:'challenging',
