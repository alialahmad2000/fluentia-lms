  ...
  blocks: [
    ...
    },
    {
      ...
      body_ar:
        ...
        + 'وملاحظة دقيقة: هذه العائلة في الحقيقة فرع خاص من العائلة الثانية (كلتاهما تضيفان لاحقة)، '
        + 'لكنّنا أفردناها لأنها النقطة التي يقع فيها أكثر الخطأ — فإن سُئلتِ عن exciting أو bored '
        + 'فالجواب المقصود هو العائلة الثالثة.',
      examples: [
