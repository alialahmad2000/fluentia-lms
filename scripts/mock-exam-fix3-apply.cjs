// scripts/mock-exam-fix3-apply.cjs — applies the AI writing grading migration via Mgmt API.
...
const FILE = 'supabase/migrations/20260522060000_mock_exam_ai_writing_grading.sql';
(async () => {
