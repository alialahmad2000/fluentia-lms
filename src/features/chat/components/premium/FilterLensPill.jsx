    ...
    <motion.button
      ...
      style={{
        background: isActive
          ...
          : 'color-mix(in oklab, var(--ds-bg-elevated) 80%, transparent)',
        border: isActive
          ? '1px solid color-mix(in oklab, var(--ds-accent-gold) 45%, transparent)'
    ...
    >
      ...
      {count > 0 && (
        <span
          ...
          style={{
            background: isActive
              ? 'color-mix(in oklab, var(--ds-accent-gold) 20%, transparent)'
