  ...
  return (
    <motion.div {...fadeRise} className="flex items-center justify-center gap-3 mt-10 mb-5 px-6" style={{ direction: 'rtl' }}>
      <div
        ...
        style={{ maxWidth: 72, background: 'linear-gradient(to left, color-mix(in oklab, var(--ds-accent-primary) 30%, transparent), transparent)' }}
      />
      <span
        ...
        style={{
          ...
          background: 'color-mix(in oklab, var(--ds-accent-primary) 11%, transparent)',
      ...
      <div
        className="flex-1 h-px"
        style={{ maxWidth: 72, background: 'linear-gradient(to right, color-mix(in oklab, var(--ds-accent-primary) 30%, transparent), transparent)' }}
      />
    </motion.div>
  )
}
