    ...
    <>
      ...
      <AnimatePresence>
        {isOpen && (
          ...
          >
            <div className="bg-navy-950 border border-border-medium rounded-2xl shadow-2xl shadow-black/40 overflow-hidden flex flex-col max-h-[70vh]">
              {/* Header */}
              <div className="flex items-center justify-between px-4 py-3 border-b border-border-subtle bg-violet-500/5">
                <div className="flex items-center gap-2">
                  ...
                  <div>
                    ...
                    <p className="text-[10px] text-muted">اسأل أي شيء</p>
                  </div>
                </div>
                <div className="flex items-center gap-1">
                  <button
                    onClick={() => setMinimized(!minimized)}
                    className="p-1.5 text-muted hover:text-white transition-colors rounded-lg hover:bg-white/5"
                  >
                    <Minimize2 size={14} />
                  </button>
                  <button
              ...
              {!minimized && (
                ...
                >
                  <input
                    ref={inputRef}
                    className="flex-1 bg-white/[0.05] border border-border-subtle rounded-xl px-3 py-2 text-sm text-white placeholder-muted/50 focus:outline-none focus:ring-1 focus:ring-violet-500/30 transition-all"
                    value={input}
                  ...
                  <button
                    ...
                    className="p-2 rounded-xl bg-violet-500/20 text-violet-400 hover:bg-violet-500/30 disabled:opacity-30 transition-all"
                  >
                    <Send size={16} />
                  </button>
                </form>
