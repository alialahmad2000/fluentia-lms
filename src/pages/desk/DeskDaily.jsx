// DeskDaily (Daily) — the habit hub. Streak + Today's mission (today's words +
// today's grammar point) + browse. The daily loop that pulls نورة back.
  ...
  return (
    <div className="space-y-7">
      ...
      <div className="desk-rise">
        ...
        <p className="font-['Inter'] text-[14px] mt-1.5 max-w-[560px] leading-relaxed" dir="ltr" style={{ color: 'rgba(243,238,226,0.58)' }}>
      ...
      <motion.div initial={rm ? false : { opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }} transition={{ ease: [0.16, 1, 0.3, 1] }}
        className="desk-glass p-6 flex items-center gap-5" style={{ borderColor: 'rgba(201,162,92,0.22)' }}>
        <div className={`desk-flame ${streak > 0 ? 'lit' : ''}`}><Flame size={26} /></div>
        <div className="min-w-0 flex-1">
          <p className="font-['Inter'] font-extrabold text-2xl leading-none" dir="ltr" style={{ color: 'var(--cream)' }}>{streak} <span className="text-[15px] font-bold" style={{ color: 'rgba(243,238,226,0.6)' }}>{streak === 1 ? 'day streak' : 'day streak'}</span></p>
          <p className="font-['Inter'] text-[13px] mt-1.5 leading-relaxed" dir="ltr" style={{ color: 'rgba(243,238,226,0.55)' }}>
      ...
      {/* today's mission */}
      <div className="desk-rise">
        <p className="font-['Inter'] text-[12px] tracking-[0.2em] mb-3" dir="ltr" style={{ color: 'rgba(201,162,92,0.6)' }}>TODAY'S MISSION</p>
        <div className="space-y-3">
          {/* vocab */}
          <Link to="/desk/daily/vocab" className="group desk-glass flex items-center gap-4 p-5" style={{ borderColor: todayVocabDone ? undefined : 'rgba(201,162,92,0.22)' }}>
          ...
          {/* grammar */}
          {grammarToday && (
            <Link to={`/desk/daily/grammar/${grammarToday.id}`} className="group desk-glass flex items-center gap-4 p-5" style={{ borderColor: todayGrammarDone ? undefined : 'rgba(201,162,92,0.22)' }}>
      ...
      {/* browse */}
      <div className="desk-rise">
        <p className="font-['Inter'] text-[12px] tracking-[0.2em] mb-3" dir="ltr" style={{ color: 'rgba(201,162,92,0.6)' }}>EXPLORE</p>
        ...
        {/* reading — next */}
        <div className="desk-glass p-4 flex items-center gap-3 mt-3 opacity-70">
          <div className="desk-mini-mark"><BookOpen size={16} /></div>
          <div className="min-w-0 flex-1"><p className="font-['Inter'] font-bold text-[14px]" dir="ltr" style={{ color: 'var(--cream)' }}>Reading in your field (IT)</p><p className="font-['Inter'] text-[11.5px]" dir="ltr" style={{ color: 'rgba(243,238,226,0.5)' }}>Technical passages & practice</p></div>
