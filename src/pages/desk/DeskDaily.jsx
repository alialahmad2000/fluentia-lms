  ...
  return (
    <div className="space-y-7">
      ...
      <div className="desk-rise">
        ...
        <p className="font-['Hanken_Grotesk'] text-[14px] mt-1.5 max-w-[560px] leading-relaxed" dir="ltr" style={{ color: 'rgba(42, 33, 64,0.58)' }}>
      ...
      <motion.div initial={rm ? false : { opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }} transition={{ ease: [0.16, 1, 0.3, 1] }}
        ...
        <div className="min-w-0 flex-1">
          <p className="font-['Hanken_Grotesk'] font-extrabold text-2xl leading-none" dir="ltr" style={{ color: 'var(--cream)' }}>{streak} <span className="text-[15px] font-bold" style={{ color: 'rgba(42, 33, 64,0.6)' }}>{streak === 1 ? 'day streak' : 'day streak'}</span></p>
          <p className="font-['Hanken_Grotesk'] text-[13px] mt-1.5 leading-relaxed" dir="ltr" style={{ color: 'rgba(42, 33, 64,0.55)' }}>
        ...
        <div className="space-y-3">
          ...
          <Link to="/desk/daily/vocab" className="group desk-glass flex items-center gap-4 p-5" style={{ borderColor: todayVocabDone ? undefined : 'rgba(239, 106, 67,0.22)' }}>
            ...
            <div className="min-w-0 flex-1">
              ...
              <p className="font-['Hanken_Grotesk'] text-[12px] mt-0.5" dir="ltr" style={{ color: 'rgba(42, 33, 64,0.5)' }}>Flashcards — I knew it or remind me</p>
            </div>
          ...
          {grammarToday && (
            <Link to={`/desk/daily/grammar/${grammarToday.id}`} className="group desk-glass flex items-center gap-4 p-5" style={{ borderColor: todayGrammarDone ? undefined : 'rgba(239, 106, 67,0.22)' }}>
              ...
              <div className="min-w-0 flex-1">
                ...
                <p className="font-['Tajawal'] text-[11.5px] mt-0.5 truncate" style={{ color: 'rgba(42, 33, 64,0.45)' }}>{grammarToday.ar}</p>
              </div>
          ...
          {nextReading && (
            <Link to={`/desk/reading/${nextReading.id}`} className="group desk-glass flex items-center gap-4 p-5" style={{ borderColor: 'rgba(239, 106, 67,0.22)' }}>
              ...
              <div className="min-w-0 flex-1">
                ...
                <p className="font-['Hanken_Grotesk'] text-[11.5px] mt-0.5" dir="ltr" style={{ color: 'rgba(42, 33, 64,0.5)' }}>{nextReading.level} · {nextReading.minutes} min · {nextReading.topic}</p>
              </div>
      ...
      <div className="desk-rise">
        ...
        <div className="grid sm:grid-cols-2 gap-3">
          <Link to="/desk/daily/vocab" className="group desk-glass p-4 flex items-center gap-3">
            ...
            <div className="min-w-0 flex-1"><p className="font-['Hanken_Grotesk'] font-bold text-[14px] whitespace-nowrap" dir="ltr" style={{ color: 'var(--cream)' }}>Word vault</p><p className="font-['Hanken_Grotesk'] text-[11.5px]" dir="ltr" style={{ color: 'rgba(42, 33, 64,0.5)' }}>{vocab.total} words</p></div>
          ...
          <Link to="/desk/daily/grammar" className="group desk-glass p-4 flex items-center gap-3">
            ...
            <div className="min-w-0 flex-1"><p className="font-['Hanken_Grotesk'] font-bold text-[14px]" dir="ltr" style={{ color: 'var(--cream)' }}>Grammar bank</p><p className="font-['Hanken_Grotesk'] text-[11.5px]" dir="ltr" style={{ color: 'rgba(42, 33, 64,0.5)' }}>{grammar.total} rules</p></div>
            <ChevronRight size={17} className="desk-lesson-chev" />
          </Link>
        </div>
        {/* reading — live */}
        <Link to="/desk/reading" className="group desk-glass p-4 flex items-center gap-3 mt-3">
          ...
          <div className="min-w-0 flex-1"><p className="font-['Hanken_Grotesk'] font-bold text-[14px]" dir="ltr" style={{ color: 'var(--cream)' }}>Reading in your field</p><p className="font-['Hanken_Grotesk'] text-[11.5px]" dir="ltr" style={{ color: 'rgba(42, 33, 64,0.5)' }}>{readingTotal} IT passages{readingDone ? ` · ${readingDone} read` : ''}</p></div>
          <ChevronRight size={17} className="desk-lesson-chev" />
        </Link>
      </div>
    </div>
