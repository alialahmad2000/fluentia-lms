...
const band = (pct) =>
  ...
  : pct >= 65 ? { en: 'Strong', c: '#efd299' }
  : pct >= 40 ? { en: 'Progressing', c: '#c9a25c' }
  : { en: 'Getting started', c: 'rgba(243,238,226,0.6)' }
  ...
  return (
    <div className="desk-glass p-4">
      <div className="flex items-center justify-between mb-2.5">
        <span className="font-['Inter'] font-bold text-[13px]" dir="ltr" style={{ color: 'rgba(243,238,226,0.8)' }}>{label}</span>
  ...
  return (
    <div className="space-y-7">
      ...
      <div className="desk-rise">
        ...
        <p className="font-['Tajawal'] text-[13px] mt-1" style={{ color: 'rgba(243,238,226,0.5)' }}>تقدّمي</p>
        <p className="font-['Inter'] text-[14px] mt-1.5" dir="ltr" style={{ color: 'rgba(243,238,226,0.55)' }}>How ready you are for English work calls — built from every call you practice.</p>
      </div>
      ...
      {attempts === 0 ? (
        <div className="desk-glass p-9 text-center desk-rise">
          ...
          <p className="font-['Inter'] text-[13px] max-w-sm mx-auto mt-2 leading-relaxed" dir="ltr" style={{ color: 'rgba(243,238,226,0.6)' }}>
        ...
        <>
          ...
          <div className="grid lg:grid-cols-[auto_1fr] gap-5 items-center">
            <motion.div initial={{ opacity: 0, scale: 0.96 }} animate={{ opacity: 1, scale: 1 }} transition={{ ease: [0.16, 1, 0.3, 1] }}
              ...
              <p className="font-['Inter'] text-[11px] mt-3" dir="ltr" style={{ color: 'rgba(243,238,226,0.45)' }}>Averaged from {attempts} graded {attempts === 1 ? 'call' : 'calls'}</p>
            </motion.div>
                  ...
                  <div key={m.id} className="flex items-center gap-3 px-4 py-3" style={{ borderColor: 'rgba(201,162,92,0.10)' }}>
                    ...
                    <div className="min-w-0 flex-1">
                      ...
                      {pct !== null ? (
                        ...
                        <p className="font-['Inter'] text-[11px] mt-0.5" dir="ltr" style={{ color: 'rgba(243,238,226,0.4)' }}>Not graded yet</p>
                      )}
                    </div>
                    {done
