  ...
  return (
    <div className="space-y-10 max-w-[720px] mx-auto">
      ...
      <div className="desk-glass desk-station-head p-6 lg:p-7 desk-rise">
        <div className="flex items-center gap-2 mb-2.5 flex-wrap font-['Inter'] text-[11.5px]" dir="ltr" style={{ color: 'rgba(243,238,226,0.5)' }}>
          <span className="px-2 py-0.5 rounded-md font-bold" style={{ color: 'var(--brass-hi)', background: 'rgba(201,162,92,0.14)' }}>{r.level}</span>
        ...
        <p className="font-['Tajawal'] text-[14px] mt-1" style={{ color: 'rgba(243,238,226,0.5)' }}>{r.title_ar}</p>
        <p className="font-['Inter'] text-[13.5px] mt-3 leading-relaxed" dir="ltr" style={{ color: 'rgba(243,238,226,0.62)' }}>{r.intro}</p>
      </div>

      {/* the passage */}
      <section className="desk-rise">
        <div className="flex items-center gap-2.5 mb-4"><span className="desk-lesson-sec-mark"><BookOpen size={16} /></span><div><p className="font-['Inter'] text-[12px] tracking-[0.18em]" dir="ltr" style={{ color: 'rgba(201,162,92,0.62)' }}>THE PASSAGE</p><h2 className="font-['Inter'] font-extrabold text-[20px] leading-tight mt-0.5" dir="ltr" style={{ color: 'var(--cream)' }}>Read</h2></div></div>
        <div className="desk-glass p-6 lg:p-7">
          ...
          <div className="space-y-4" dir="ltr">
            {r.paragraphs.map((p, k) => (
              <p key={k} className="font-['Inter'] text-[15.5px] leading-[1.95]" style={{ color: 'rgba(243,238,226,0.86)' }}>{p}</p>
            ))}
          </div>
        </div>
      </section>
      ...
      {r.key_terms?.length > 0 && (
        <section className="desk-rise">
          <div className="flex items-center gap-2.5 mb-4"><span className="desk-lesson-sec-mark"><Sparkles size={16} /></span><div><p className="font-['Inter'] text-[12px] tracking-[0.18em]" dir="ltr" style={{ color: 'rgba(201,162,92,0.62)' }}>KEY TERMS</p><h2 className="font-['Inter'] font-extrabold text-[20px] leading-tight mt-0.5" dir="ltr" style={{ color: 'var(--cream)' }}>Words that matter</h2></div></div>
              ...
              <div key={k} className="desk-glass p-4 flex items-start justify-between gap-3">
                <div className="min-w-0">
                  <div className="flex items-baseline gap-2 flex-wrap">
                    ...
                    {t.ipa && <span className="font-['Inter'] text-[12px]" dir="ltr" style={{ color: 'rgba(201,162,92,0.7)' }}>/{t.ipa}/</span>}
                    <span className="font-['Tajawal'] text-[13px]" style={{ color: 'var(--brass-hi)' }}>{t.ar}</span>
                  </div>
                  <p className="font-['Inter'] text-[12.5px] mt-1 leading-snug" dir="ltr" style={{ color: 'rgba(243,238,226,0.55)' }}>{t.def_en}</p>
                </div>
                <PlayBtn text={t.term} />
              </div>
            ))}
      ...
      {r.questions?.length > 0 && (
        <section className="desk-rise">
          <div className="flex items-center gap-2.5 mb-4"><span className="desk-lesson-sec-mark"><HelpCircle size={16} /></span><div><p className="font-['Inter'] text-[12px] tracking-[0.18em]" dir="ltr" style={{ color: 'rgba(201,162,92,0.62)' }}>CHECK</p><h2 className="font-['Inter'] font-extrabold text-[20px] leading-tight mt-0.5" dir="ltr" style={{ color: 'var(--cream)' }}>Did you get it?</h2></div></div>
...
function ReadingQ({ q, onResolve }) {
  ...
  return (
    <div className="desk-glass p-6">
      <p className="font-['Inter'] text-[14.5px] font-semibold mb-3.5 leading-relaxed" dir="ltr" style={{ color: 'rgba(243,238,226,0.9)' }}>{q.q}</p>
