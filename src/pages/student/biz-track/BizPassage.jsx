// Self-contained business reading with tap-to-translate: the lesson's key vocab words are
...
export default function BizPassage({ title_en, paragraphs = [], vocab = [], accent = '#f59e0b' }) {
