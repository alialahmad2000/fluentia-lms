...
const PATH_CHIPS = [
  ...
  { to: '/student/leaderboard', label: 'المتصدّرون', icon: Trophy, hue: '#fbbf24', soft: 'rgba(251,191,36,0.15)' },
]
    ...
    <div className="pd-root">
      ...
      <div className="space-y-6" style={{ position: 'relative', zIndex: 1, maxWidth: 1200, margin: '0 auto' }}>
        ...
        <div className="space-y-3">
          ...
          <Section title="إيقاعك ومجموعتك" icon={Flame} hue="#fb923c" soft="rgba(251,146,60,0.13)">
            <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
