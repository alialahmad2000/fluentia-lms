// Self-contained environment reading with tap-to-translate: the lesson's key vocab words are
...
export default function EnvPassage({ title_en, paragraphs = [], vocab = [], accent = '#22c55e' }) {
