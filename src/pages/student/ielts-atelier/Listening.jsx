...
function AccentBadge({ accent }) {
  ...
  return (
    <span style={{
      ...
      background: 'color-mix(in oklab, var(--ds-surface) 80%, transparent)',
      border: '1px solid color-mix(in oklab, var(--ds-border) 50%, transparent)',
    }}>
      {label}
    </span>
  )
...
function AudioPlayer({ audioRef, isPlaying, currentTime, duration, playbackSpeed, started, onStart, onPlayPause, onSeek, onReplay, onSpeedChange }) {
    ...
    return (
      <motion.button
        ...
        style={{
          ...
          padding: '18px',
          borderRadius: 16,
          border: '1px solid color-mix(in oklab, var(--sunset-orange) 40%, transparent)',
          background: 'color-mix(in oklab, var(--sunset-orange) 16%, var(--sunset-base-mid))',
          color: 'var(--ds-text)',
          fontSize: 17,
          fontWeight: 900,
  ...
  return (
    <div style={{
      padding: '16px 20px',
      borderRadius: 18,
      background: 'color-mix(in oklab, var(--sunset-base-mid) 45%, transparent)',
      ...
      {/* Scrub bar */}
      <div style={{ position: 'relative', height: 4, borderRadius: 99, background: 'color-mix(in oklab, var(--ds-border) 40%, transparent)', cursor: 'pointer' }}>
        <div style={{
          height: '100%',
          width: `${progress}%`,
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
        ...
        <button
          ...
          style={{
            ...
            borderRadius: '50%',
            border: '1px solid color-mix(in oklab, var(--ds-border) 50%, transparent)',
            background: 'color-mix(in oklab, var(--ds-surface) 50%, transparent)',
            color: 'var(--ds-text-muted)',
            display: 'flex',
            alignItems: 'center',
            justifyContent: 'center',
        ...
        <button
          ...
          style={{
            ...
            height: 46,
            borderRadius: '50%',
            border: '1px solid color-mix(in oklab, var(--sunset-orange) 45%, transparent)',
            background: 'color-mix(in oklab, var(--sunset-orange) 18%, transparent)',
            color: 'var(--ds-text)',
            display: 'flex',
            alignItems: 'center',
            justifyContent: 'center',
          ...
          {[0.75, 1, 1.25].map(s => (
            <button
              ...
              style={{
                padding: '3px 7px',
                borderRadius: 6,
                border: `1px solid ${playbackSpeed === s ? 'var(--sunset-orange)' : 'color-mix(in oklab, var(--ds-border) 50%, transparent)'}`,
                background: playbackSpeed === s ? 'color-mix(in oklab, var(--sunset-orange) 16%, transparent)' : 'transparent',
...
function QuestionItem({ q, answer, onChange }) {
  ...
  return (
    <div style={{
      padding: '14px 16px',
      borderRadius: 14,
      background: 'color-mix(in oklab, var(--ds-surface) 60%, transparent)',
      border: `1px solid ${answered ? 'color-mix(in oklab, var(--sunset-orange) 28%, transparent)' : 'color-mix(in oklab, var(--ds-border) 55%, transparent)'}`,
      display: 'flex',
      flexDirection: 'column',
      gap: 10,
      ...
      <div style={{ display: 'flex', gap: 8, alignItems: 'flex-start' }}>
        <span style={{
          ...
          height: 22,
          borderRadius: '50%',
          background: answered ? 'color-mix(in oklab, var(--sunset-orange) 18%, transparent)' : 'color-mix(in oklab, var(--ds-surface) 80%, transparent)',
            ...
            return (
              <button
                ...
                style={{
                  ...
                  height: 36,
                  borderRadius: '50%',
                  border: `2px solid ${selected ? 'var(--sunset-orange)' : 'color-mix(in oklab, var(--ds-border) 70%, transparent)'}`,
                  background: selected ? 'color-mix(in oklab, var(--sunset-orange) 18%, transparent)' : 'transparent',
            ...
            return (
              <button
                ...
                style={{
                  padding: '5px 12px',
                  borderRadius: 8,
                  border: `1px solid ${selected ? 'var(--sunset-orange)' : 'color-mix(in oklab, var(--ds-border) 60%, transparent)'}`,
                  background: selected ? 'color-mix(in oklab, var(--sunset-orange) 14%, transparent)' : 'transparent',
                  color: selected ? 'var(--ds-text)' : 'var(--ds-text-muted)',
                  fontSize: 12,
                  fontWeight: selected ? 700 : 500,
                  fontFamily: "'IBM Plex Sans', sans-serif",
      ...
      {!isLetterMCQ && !isMatching && !(isMCQ && hasOptions) && (
        <input
          ...
          style={{
            ...
            padding: '8px 12px',
            borderRadius: 8,
            border: `1px solid ${answer ? 'var(--sunset-orange)' : 'color-mix(in oklab, var(--ds-border) 60%, transparent)'}`,
            background: 'color-mix(in oklab, var(--ds-surface) 70%, transparent)',
            color: 'var(--ds-text)',
            fontSize: 14,
            fontFamily: "'IBM Plex Mono', monospace",
            outline: 'none',
            ...
            return (
              <button
                ...
                style={{
                  ...
                  background: active ? 'color-mix(in oklab, var(--sunset-orange) 14%, transparent)' : 'color-mix(in oklab, var(--ds-surface) 50%, transparent)',
        ...
        {hallQ.isLoading ? (
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(280px, 1fr))', gap: 14 }}>
            {Array(4).fill(0).map((_, i) => (
              <div key={i} style={{
                height: 180,
                borderRadius: 18,
                background: 'color-mix(in oklab, var(--ds-surface) 35%, transparent)',
                border: '1px solid color-mix(in oklab, var(--ds-border) 35%, transparent)',
              }} />
            ))}
          </div>
        ) : sections.length === 0 ? (
          <motion.div
            ...
            style={{
              padding: '40px 24px',
              borderRadius: 20,
              background: 'color-mix(in oklab, var(--ds-surface) 40%, transparent)',
              border: '1px solid color-mix(in oklab, var(--ds-border) 40%, transparent)',
              textAlign: 'center',
            }}
          >
      ...
      <div dir="rtl" style={{ maxWidth: 640, margin: '0 auto', paddingBottom: 80, display: 'flex', flexDirection: 'column', gap: 28 }}>
        ...
        <motion.div
          ...
          style={{
            padding: '40px 32px',
            borderRadius: 24,
            background: 'color-mix(in oklab, var(--sunset-base-mid) 48%, transparent)',
            border: '1px solid color-mix(in oklab, var(--sunset-amber) 22%, transparent)',
            backdropFilter: 'blur(10px)',
            textAlign: 'center',
            display: 'flex',
        ...
        >
          <button
            ...
            style={{
              ...
              padding: '12px',
              borderRadius: 12,
              border: '1px solid color-mix(in oklab, var(--ds-border) 55%, transparent)',
              background: 'color-mix(in oklab, var(--ds-surface) 45%, transparent)',
              color: 'var(--ds-text-muted)',
              fontSize: 14,
              fontWeight: 700,
              fontFamily: "'Tajawal', sans-serif",
          ...
          <button
            ...
            style={{
              ...
              padding: '12px',
              borderRadius: 12,
              border: '1px solid color-mix(in oklab, var(--sunset-orange) 38%, transparent)',
              background: 'color-mix(in oklab, var(--sunset-orange) 13%, transparent)',
              color: 'var(--ds-text)',
              fontSize: 14,
              fontWeight: 700,
              fontFamily: "'Tajawal', sans-serif",
        ...
        >
          <button
            ...
            style={{
              ...
              padding: '12px 16px',
              borderRadius: 12,
              border: '1px solid color-mix(in oklab, var(--ds-border) 45%, transparent)',
              background: 'color-mix(in oklab, var(--ds-surface) 45%, transparent)',
              color: 'var(--ds-text-muted)',
              fontSize: 14,
              fontFamily: "'Tajawal', sans-serif",
